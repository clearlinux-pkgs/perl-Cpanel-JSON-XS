...
%prep
%setup -q -n Cpanel-JSON-XS-4.19
cd %{_builddir}/Cpanel-JSON-XS-4.19
...
cp %{_builddir}/Cpanel-JSON-XS-4.19/COPYING %{buildroot}/usr/share/package-licenses/perl-Cpanel-JSON-XS/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
