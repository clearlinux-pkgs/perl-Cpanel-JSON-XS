...
Source0  : https://cpan.metacpan.org/authors/id/R/RU/RURBAN/Cpanel-JSON-XS-4.24.tar.gz
...
%prep
%setup -q -n Cpanel-JSON-XS-4.24
cd %{_builddir}/Cpanel-JSON-XS-4.24
...
cp %{_builddir}/Cpanel-JSON-XS-4.24/COPYING %{buildroot}/usr/share/package-licenses/perl-Cpanel-JSON-XS/9a56f3b919dfc8fced3803e165a2e38de62646e5
if test -f Makefile.PL; then
